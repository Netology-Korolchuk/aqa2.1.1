...
class CallbackTest {
    ...
    void shouldTestAllFieldsCorrectly() {
        ...
        $("[data-test-id=name] input").setValue("Âàñèëèé");
        $("[data-test-id=phone] input").setValue("+79270000000");
        $("[data-test-id=agreement]").click();
        $(".button").click();
        $("[data-test-id=order-success]").shouldHave(exactText("Âàøà çàÿâêà óñïåøíî îòïðàâëåíà! Íàø ìåíåäæåð ñâÿæåòñÿ ñ âàìè â áëèæàéøåå âðåìÿ."));
    }
